...
const ManagerPage = ({ navigation, route }) => {
  const handleRS = () => {
    navigation.navigate('RS_Approval', { userId: "관리자" });
  };
  const handleSU = () => {
    navigation.navigate('SU_Approval', { userId: "관리자" });
  };
  ...
  return (
    ...
    <TouchableOpacity style={styles.GymButton} onPress={handleSU}>
        <View style={styles.buttonContent}>
            <Image source={require('../../assets/gym-icon.png')} style={{ width: wp('40%') , height:hp('20%'),
            resizeMode: 'contain' }} />
        </View>
        <Text style={styles.ButtonText}>회원가입 승인</Text>
        <Text style={styles.ArrowText}> {'>'} </Text>
      </TouchableOpacity>
      <TouchableOpacity style={styles.GymButton} onPress={handleRS}>
        <View style={styles.buttonContent}>
            <Image source={require('../../assets/gym-icon.png')} style={{ width: wp('40%') , height:hp('20%'),
            resizeMode: 'contain' }} />
        </View>
